...
export class ColumnDirective {
  ...
  @ContentChild(CellDirective, { static: true }) tempCell?: CellDirective;
  @ContentChild(HeaderDirective, { static: true }) tempHeader?: HeaderDirective;
